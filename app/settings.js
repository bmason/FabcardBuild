...
Drupal.settings.site_path = 'http://fabcardasia.co.th';  // e.g. http://www.example.com
...
// App Title
drupalgap.settings.title = 'Fab Card';
...
// Logo
drupalgap.settings.logo = 'images/FabCardlogo.jpg'; //'themes/easystreet3/images/drupalgap.jpg';

// Offline Warning Message. Set to false to hide message.
drupalgap.settings.offline_message = 'No connection found!';

// Exit app message.
drupalgap.settings.exit_message = t('Exit ' + drupalgap.settings.title + '?');
